...
docker pull ghcr.io/iaa-so-training/day4-clustering:latest    # current release: day4-v7
...
`The guide was verified against the `day4-v7` release (manifest list digest
`sha256:b1590f7d…`); `docker pull …@sha256:b1590f7d…` freezes that exact image if
