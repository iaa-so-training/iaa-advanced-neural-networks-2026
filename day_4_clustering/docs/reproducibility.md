...
| container `day4-v5` (`sha256:ffea4cfb…`), default threads | 0.2093 / 0.2230 | 0.2227 / 0.1333 | 0.4828 / 0.0024 |
| container `day4-v4` (`sha256:9691829b…`), default threads | 0.2093 / 0.2230 | 0.2227 / 0.1333 | 0.4828 / 0.0024 |
...
1. **The base image is part of the environment.** The `day4-v2` image was built
   ...
   native and container agree to the last printed digit, across two releases.
...
```bash
docker pull ghcr.io/iaa-so-training/day4-clustering@sha256:ffea4cfb232b9cee38875cfbc01461df57352961349a744dad651156b1f34e62
```
