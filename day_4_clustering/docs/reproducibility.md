...
| container `day4-v6` (= `:latest`, `sha256:d3f6231e…`), default threads | 0.2093 / 0.2230 | 0.2227 / 0.1333 | 0.4828 / 0.0024 |
| container `day4-v4`, `day4-v5`, default threads | 0.2093 / 0.2230 | 0.2227 / 0.1333 | 0.4828 / 0.0024 |
...
1. **The base image is part of the environment.** The `day4-v2` image was built
   ...
   releases (`day4-v4`, `day4-v5`, `day4-v6`), each re-measured end to end.
...
```bash
docker pull ghcr.io/iaa-so-training/day4-clustering@sha256:d3f6231eca07852e7078954303236de2aba1997ef997c8daf1bc2a2570909ba5
```
